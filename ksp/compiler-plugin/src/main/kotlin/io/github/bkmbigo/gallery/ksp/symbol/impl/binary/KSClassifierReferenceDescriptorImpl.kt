...
class KSClassifierReferenceDescriptorImpl private constructor(
    ...
    companion object : KSObjectCache<Triple<ClassifierDescriptor, List<TypeProjection>, Pair<io.github.bkmbigo.gallery.ksp.symbol.KSNode?, Origin>>,
        KSClassifierReferenceDescriptorImpl>() {
        fun getCached(kotlinType: KotlinType, origin: Origin, parent: io.github.bkmbigo.gallery.ksp.symbol.KSNode?) = cache.getOrPut(
            Triple(
        ...
        fun getCached(
            ...
            origin: Origin,
            parent: io.github.bkmbigo.gallery.ksp.symbol.KSNode?
        ) = cache.getOrPut(
