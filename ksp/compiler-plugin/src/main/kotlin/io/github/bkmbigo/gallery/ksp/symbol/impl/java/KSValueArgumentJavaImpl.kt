...
import io.github.bkmbigo.gallery.ksp.symbol.impl.kotlin.KSValueArgumentImpl
...
class KSValueArgumentJavaImpl private constructor(
    ...
    companion object : KSObjectCache<Triple<KSName?, Any?, io.github.bkmbigo.gallery.ksp.symbol.KSNode?>, KSValueArgumentJavaImpl>() {
        fun getCached(name: KSName?, value: Any?, parent: io.github.bkmbigo.gallery.ksp.symbol.KSNode?) =
