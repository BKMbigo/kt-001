...
abstract class KSTopDownVisitor<D, R> : KSDefaultVisitor<D, R>() {
    private fun Sequence<io.github.bkmbigo.gallery.ksp.symbol.KSNode>.accept(data: D) {
        forEach { it.accept(this@KSTopDownVisitor, data) }
    }
    private fun List<io.github.bkmbigo.gallery.ksp.symbol.KSNode>.accept(data: D) {
        forEach { it.accept(this@KSTopDownVisitor, data) }
    }

    private fun io.github.bkmbigo.gallery.ksp.symbol.KSNode.accept(data: D) = accept(this@KSTopDownVisitor, data)
