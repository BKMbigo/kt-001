...
interface Resolver {
     ...
     */
    fun getClassDeclarationByName(name: KSName): io.github.bkmbigo.gallery.ksp.symbol.KSClassDeclaration?
     ...
     * Calling [overrides] is expensive and should be avoided if possible.
     */
    fun overrides(overrider: KSDeclaration, overridee: KSDeclaration, containingClass: io.github.bkmbigo.gallery.ksp.symbol.KSClassDeclaration): Boolean
     ...
     */
    @KspExperimental
    fun getJvmName(accessor: io.github.bkmbigo.gallery.ksp.symbol.KSPropertyAccessor): String?
     ...
     */
    @KspExperimental
    fun getJvmCheckedException(accessor: io.github.bkmbigo.gallery.ksp.symbol.KSPropertyAccessor): Sequence<KSType>
