 ...
 */
interface KSClassDeclaration : io.github.bkmbigo.gallery.ksp.symbol.KSDeclaration,
    io.github.bkmbigo.gallery.ksp.symbol.KSDeclarationContainer {

    /**
     * The Kind of the class declaration.
     */
    val classKind: io.github.bkmbigo.gallery.ksp.symbol.ClassKind

    /**
     * Primary constructor of a class, secondary constructors can be obtained by filtering [declarations].
     */
    val primaryConstructor: io.github.bkmbigo.gallery.ksp.symbol.KSFunctionDeclaration?

    /**
     * Sequence of supertypes of this class, containing both super class and implemented interfaces.
     */
    val superTypes: Sequence<io.github.bkmbigo.gallery.ksp.symbol.KSTypeReference>
     ...
     */
    fun getSealedSubclasses(): Sequence<io.github.bkmbigo.gallery.ksp.symbol.KSClassDeclaration>
     ...
     */
    fun getAllFunctions(): Sequence<io.github.bkmbigo.gallery.ksp.symbol.KSFunctionDeclaration>
     ...
     */
    fun getAllProperties(): Sequence<io.github.bkmbigo.gallery.ksp.symbol.KSPropertyDeclaration>
     ...
     */
    fun asType(typeArguments: List<io.github.bkmbigo.gallery.ksp.symbol.KSTypeArgument>): io.github.bkmbigo.gallery.ksp.symbol.KSType
     ...
     */
    fun asStarProjectedType(): io.github.bkmbigo.gallery.ksp.symbol.KSType
}
