 ...
 */
open class KSVisitorVoid : io.github.bkmbigo.gallery.ksp.symbol.KSVisitor<Unit, Unit> {
    override fun visitNode(node: io.github.bkmbigo.gallery.ksp.symbol.KSNode, data: Unit) {
    }
    ...
    override fun visitParenthesizedReference(reference: io.github.bkmbigo.gallery.ksp.symbol.KSParenthesizedReference, data: Unit) {
    }

    override fun visitPropertyDeclaration(property: KSPropertyDeclaration, data: Unit) {
    }

    override fun visitPropertyAccessor(accessor: io.github.bkmbigo.gallery.ksp.symbol.KSPropertyAccessor, data: Unit) {
    }
