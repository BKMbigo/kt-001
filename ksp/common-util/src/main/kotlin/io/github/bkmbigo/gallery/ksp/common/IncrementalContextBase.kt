...
package io.github.bkmbigo.gallery.ksp.common
...
import io.github.bkmbigo.gallery.ksp.visitor.KSDefaultVisitor
...
object symbolCollector : KSDefaultVisitor<(LookupSymbolWrapper) -> Unit, Unit>() {
    override fun defaultHandler(node: io.github.bkmbigo.gallery.ksp.symbol.KSNode, data: (LookupSymbolWrapper) -> Unit) = Unit
...
abstract class IncrementalContextBase(
    ...
    fun recordGetSealedSubclasses(classDeclaration: io.github.bkmbigo.gallery.ksp.symbol.KSClassDeclaration) {
