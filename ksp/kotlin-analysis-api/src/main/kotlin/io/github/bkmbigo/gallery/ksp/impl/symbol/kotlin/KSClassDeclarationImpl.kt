...
import io.github.bkmbigo.gallery.ksp.impl.recordGetSealedSubclasses
        ...
        return analyze {
            KSTypeImpl.getCached(
                analysisSession.buildClassType(ktClassOrObjectSymbol) {
                    var current: io.github.bkmbigo.gallery.ksp.symbol.KSNode? = this@KSClassDeclarationImpl
