 ...
 */
abstract class KSEmptyVisitor<D, R> : io.github.bkmbigo.gallery.ksp.symbol.KSVisitor<D, R> {
    abstract fun defaultHandler(node: io.github.bkmbigo.gallery.ksp.symbol.KSNode, data: D): R

    override fun visitNode(node: io.github.bkmbigo.gallery.ksp.symbol.KSNode, data: D): R {
    ...
    override fun visitParenthesizedReference(reference: io.github.bkmbigo.gallery.ksp.symbol.KSParenthesizedReference, data: D): R {
        return defaultHandler(reference, data)
    }
    ...
    override fun visitPropertyAccessor(accessor: io.github.bkmbigo.gallery.ksp.symbol.KSPropertyAccessor, data: D): R {
        return defaultHandler(accessor, data)
    }

    override fun visitPropertyGetter(getter: io.github.bkmbigo.gallery.ksp.symbol.KSPropertyGetter, data: D): R {
        return defaultHandler(getter, data)
    }

    override fun visitPropertySetter(setter: io.github.bkmbigo.gallery.ksp.symbol.KSPropertySetter, data: D): R {
    ...
    override fun visitClassDeclaration(classDeclaration: io.github.bkmbigo.gallery.ksp.symbol.KSClassDeclaration, data: D): R {
