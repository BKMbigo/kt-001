 ...
 */
package io.github.bkmbigo.gallery.ksp

import io.github.bkmbigo.gallery.ksp.processing.Resolver
import io.github.bkmbigo.gallery.ksp.symbol.*
import io.github.bkmbigo.gallery.ksp.visitor.KSValidateVisitor
 ...
 */
inline fun <reified T> Resolver.getClassDeclarationByName(): io.github.bkmbigo.gallery.ksp.symbol.KSClassDeclaration? {
 ...
 */
val io.github.bkmbigo.gallery.ksp.symbol.KSNode.containingFile: KSFile?
    get() {
 ...
 */
fun io.github.bkmbigo.gallery.ksp.symbol.KSClassDeclaration.getDeclaredFunctions(): Sequence<KSFunctionDeclaration> {
 ...
 */
fun io.github.bkmbigo.gallery.ksp.symbol.KSClassDeclaration.getDeclaredProperties(): Sequence<KSPropertyDeclaration> {
    return this.declarations.filterIsInstance<KSPropertyDeclaration>()
}

fun io.github.bkmbigo.gallery.ksp.symbol.KSClassDeclaration.getConstructors(): Sequence<KSFunctionDeclaration> {
...
fun KSDeclaration.isLocal(): Boolean {
    return this.parentDeclaration != null && this.parentDeclaration !is io.github.bkmbigo.gallery.ksp.symbol.KSClassDeclaration
}
 ...
 */
fun io.github.bkmbigo.gallery.ksp.symbol.KSNode.validate(predicate: (io.github.bkmbigo.gallery.ksp.symbol.KSNode?, io.github.bkmbigo.gallery.ksp.symbol.KSNode) -> Boolean = { _, _ -> true }): Boolean {
 ...
 */
fun KSTypeAlias.findActualType(): io.github.bkmbigo.gallery.ksp.symbol.KSClassDeclaration {
    val resolvedType = this.type.resolve().declaration
    return if (resolvedType is KSTypeAlias) {
        resolvedType.findActualType()
    } else {
        resolvedType as io.github.bkmbigo.gallery.ksp.symbol.KSClassDeclaration
    }
}
 ...
 */
fun io.github.bkmbigo.gallery.ksp.symbol.KSClassDeclaration.getAllSuperTypes(): Sequence<KSType> {

    fun KSTypeParameter.getTypesUpperBound(): Sequence<io.github.bkmbigo.gallery.ksp.symbol.KSClassDeclaration> =
        this.bounds.asSequence().flatMap {
            when (val resolvedDeclaration = it.resolve().declaration) {
                is io.github.bkmbigo.gallery.ksp.symbol.KSClassDeclaration -> sequenceOf(resolvedDeclaration)
    ...
    return this.superTypes
        ...
        .plus(
            this.superTypes
                ...
                .flatMap {
                    when (it) {
                        is io.github.bkmbigo.gallery.ksp.symbol.KSClassDeclaration -> it.getAllSuperTypes()
...
fun io.github.bkmbigo.gallery.ksp.symbol.KSClassDeclaration.isAbstract() =
...
fun KSPropertyDeclaration.isAbstract(): Boolean {
    ...
    val parentClass = parentDeclaration as? io.github.bkmbigo.gallery.ksp.symbol.KSClassDeclaration ?: return false
...
fun KSDeclaration.isOpen() = !this.isLocal() && !this.modifiers.contains(Modifier.FINAL) &&
    (
        (this as? io.github.bkmbigo.gallery.ksp.symbol.KSClassDeclaration)?.classKind == ClassKind.INTERFACE ||
            this.modifiers.contains(Modifier.OVERRIDE) ||
            this.modifiers.contains(Modifier.ABSTRACT) ||
            this.modifiers.contains(Modifier.OPEN) ||
            this.modifiers.contains(Modifier.SEALED) ||
            (
                this !is io.github.bkmbigo.gallery.ksp.symbol.KSClassDeclaration &&
                    (this.parentDeclaration as? io.github.bkmbigo.gallery.ksp.symbol.KSClassDeclaration)?.classKind == ClassKind.INTERFACE
                ) ||
...
fun KSDeclaration.closestClassDeclaration(): io.github.bkmbigo.gallery.ksp.symbol.KSClassDeclaration? {
    return if (this is io.github.bkmbigo.gallery.ksp.symbol.KSClassDeclaration) {
        this
    } else {
...
val KSType.outerType: KSType?
    get() {
        if (Modifier.INNER !in declaration.modifiers)
            return null
        val outerDecl = declaration.parentDeclaration as? io.github.bkmbigo.gallery.ksp.symbol.KSClassDeclaration ?: return null
...
@KspExperimental
fun Resolver.getKotlinClassByName(name: KSName): io.github.bkmbigo.gallery.ksp.symbol.KSClassDeclaration? {
    val kotlinName = mapJavaNameToKotlin(name) ?: name
    return getClassDeclarationByName(kotlinName)
}

@KspExperimental
fun Resolver.getKotlinClassByName(name: String): io.github.bkmbigo.gallery.ksp.symbol.KSClassDeclaration? =
    getKotlinClassByName(getKSNameFromString(name))

@KspExperimental
fun Resolver.getJavaClassByName(name: KSName): io.github.bkmbigo.gallery.ksp.symbol.KSClassDeclaration? {
    val javaName = mapKotlinNameToJava(name) ?: name
    return getClassDeclarationByName(javaName)
}

@KspExperimental
fun Resolver.getJavaClassByName(name: String): io.github.bkmbigo.gallery.ksp.symbol.KSClassDeclaration? =
