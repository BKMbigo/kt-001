...
import io.github.bkmbigo.gallery.ksp.common.NoSourceFile
import io.github.bkmbigo.gallery.ksp.processing.CodeGenerator
import io.github.bkmbigo.gallery.ksp.processing.Dependencies
...
class CodeGeneratorImpl(
    ...
    override fun associateWithClasses(
        classes: List<io.github.bkmbigo.gallery.ksp.symbol.KSClassDeclaration>,
        packageName: String,
        fileName: String,
        extensionName: String
    ) {
