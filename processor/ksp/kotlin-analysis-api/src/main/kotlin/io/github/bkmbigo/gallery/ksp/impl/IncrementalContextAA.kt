...
import io.github.bkmbigo.gallery.ksp.common.FileToSymbolsMap
import io.github.bkmbigo.gallery.ksp.common.IncrementalContextBase
import io.github.bkmbigo.gallery.ksp.common.LookupStorageWrapper
import io.github.bkmbigo.gallery.ksp.common.LookupSymbolWrapper
import io.github.bkmbigo.gallery.ksp.common.LookupTrackerWrapper
import io.github.bkmbigo.gallery.ksp.containingFile
import io.github.bkmbigo.gallery.ksp.impl.symbol.kotlin.KSFileJavaImpl
import io.github.bkmbigo.gallery.ksp.impl.symbol.kotlin.KSFunctionDeclarationImpl
import io.github.bkmbigo.gallery.ksp.impl.symbol.kotlin.KSPropertyDeclarationImpl
import io.github.bkmbigo.gallery.ksp.impl.symbol.kotlin.KSPropertyDeclarationJavaImpl
import io.github.bkmbigo.gallery.ksp.impl.symbol.kotlin.analyze
import io.github.bkmbigo.gallery.ksp.impl.symbol.kotlin.typeArguments
...
class IncrementalContextAA(
    ...
    override val symbolLookupTracker =
        LookupTrackerWrapperImpl((lookupTracker as? io.github.bkmbigo.gallery.ksp.impl.DualLookupTracker)?.symbolTracker ?: LookupTracker.DO_NOTHING)
    ...
    override val classLookupTracker =
        LookupTrackerWrapperImpl((lookupTracker as? io.github.bkmbigo.gallery.ksp.impl.DualLookupTracker)?.classTracker ?: LookupTracker.DO_NOTHING)
    ...
    fun recordLookup(type: KtType, context: io.github.bkmbigo.gallery.ksp.symbol.KSNode?) {
...
internal fun recordLookup(ktType: KtType, context: io.github.bkmbigo.gallery.ksp.symbol.KSNode?) =
...
internal fun recordGetSealedSubclasses(classDeclaration: io.github.bkmbigo.gallery.ksp.symbol.KSClassDeclaration) =
