...
import io.github.bkmbigo.gallery.ksp.common.KSObjectCacheManager
...
import io.github.bkmbigo.gallery.ksp.impl.symbol.kotlin.KSFileImpl
...
import io.github.bkmbigo.gallery.ksp.standalone.IncrementalKotlinDeclarationProviderFactory
import io.github.bkmbigo.gallery.ksp.standalone.IncrementalKotlinPackageProviderFactory
import io.github.bkmbigo.gallery.ksp.standalone.buildKspLibraryModule
import io.github.bkmbigo.gallery.ksp.standalone.buildKspSourceModule
...
class KotlinSymbolProcessing(
    ...
    fun execute(): ExitCode {
        ...
        val logger = object : KSPLogger by logger {
            ...
            override fun error(message: String, symbol: io.github.bkmbigo.gallery.ksp.symbol.KSNode?) {
                hasError = true
                logger.error(message, symbol)
            }

            override fun warn(message: String, symbol: io.github.bkmbigo.gallery.ksp.symbol.KSNode?) {
        ...
        val dualLookupTracker = io.github.bkmbigo.gallery.ksp.impl.DualLookupTracker()
