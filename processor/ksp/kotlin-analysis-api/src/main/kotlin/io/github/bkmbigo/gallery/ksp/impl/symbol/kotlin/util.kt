...
import io.github.bkmbigo.gallery.ksp.impl.KSPCoreEnvironment
import io.github.bkmbigo.gallery.ksp.impl.ResolverAAImpl
import io.github.bkmbigo.gallery.ksp.impl.symbol.kotlin.resolved.KSClassifierParameterImpl
import io.github.bkmbigo.gallery.ksp.impl.symbol.kotlin.resolved.KSClassifierReferenceResolvedImpl
import io.github.bkmbigo.gallery.ksp.impl.symbol.util.getDocString
...
internal fun KSTypeArgument.toKtTypeProjection(): KtTypeProjection {
    val variance = when (this.variance) {
        io.github.bkmbigo.gallery.ksp.symbol.Variance.INVARIANT -> Variance.INVARIANT
        io.github.bkmbigo.gallery.ksp.symbol.Variance.COVARIANT -> Variance.OUT_VARIANCE
        io.github.bkmbigo.gallery.ksp.symbol.Variance.CONTRAVARIANT -> Variance.IN_VARIANCE
        else -> null
    }
...
internal fun PsiElement?.toLocation(): io.github.bkmbigo.gallery.ksp.symbol.Location {
    if (this == null) {
        return io.github.bkmbigo.gallery.ksp.symbol.NonExistLocation
    }
    val file = this.containingFile
    val document = KSPCoreEnvironment.instance.psiDocumentManager.getDocument(file) ?: return io.github.bkmbigo.gallery.ksp.symbol.NonExistLocation
    return io.github.bkmbigo.gallery.ksp.symbol.FileLocation(
        file.virtualFile.path,
        document.getLineNumber(this.textOffset) + 1
    )
}
...
internal fun KtAnnotated.annotations(parent: io.github.bkmbigo.gallery.ksp.symbol.KSNode? = null): Sequence<KSAnnotation> {
...
internal fun KtSymbol.toKSNode(): io.github.bkmbigo.gallery.ksp.symbol.KSNode {
    return when (this) {
...
internal fun KSAnnotated.findAnnotationFromUseSiteTarget(): Sequence<KSAnnotation> {
    return when (this) {
        is io.github.bkmbigo.gallery.ksp.symbol.KSPropertyGetter -> (this.receiver as? AbstractKSDeclarationImpl)?.let {
            it.originalAnnotations.asSequence().filter { it.useSiteTarget == AnnotationUseSiteTarget.GET }
        }
        is io.github.bkmbigo.gallery.ksp.symbol.KSPropertySetter -> (this.receiver as? AbstractKSDeclarationImpl)?.let {
...
internal inline fun <reified T : io.github.bkmbigo.gallery.ksp.symbol.KSNode> io.github.bkmbigo.gallery.ksp.symbol.KSNode.findParentOfType(): io.github.bkmbigo.gallery.ksp.symbol.KSNode? {
    var result = parent
    ...
    return this.psi.let {
        when (it) {
            ...
            null -> {
                ...
                val parentClass = this.getContainingKSSymbol()!!.findParentOfType<io.github.bkmbigo.gallery.ksp.symbol.KSClassDeclaration>()
