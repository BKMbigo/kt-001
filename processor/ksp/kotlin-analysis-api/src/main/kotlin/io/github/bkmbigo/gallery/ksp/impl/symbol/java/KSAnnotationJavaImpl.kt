...
import io.github.bkmbigo.gallery.ksp.impl.symbol.kotlin.KSValueArgumentImpl
...
import io.github.bkmbigo.gallery.ksp.impl.symbol.kotlin.getDefaultValue
...
import io.github.bkmbigo.gallery.ksp.symbol.AnnotationUseSiteTarget
...
class KSAnnotationJavaImpl private constructor(private val psi: PsiAnnotation, override val parent: io.github.bkmbigo.gallery.ksp.symbol.KSNode?) :
    KSAnnotation {
    companion object : KSObjectCache<PsiAnnotation, KSAnnotationJavaImpl>() {
        fun getCached(psi: PsiAnnotation, parent: io.github.bkmbigo.gallery.ksp.symbol.KSNode?) =
