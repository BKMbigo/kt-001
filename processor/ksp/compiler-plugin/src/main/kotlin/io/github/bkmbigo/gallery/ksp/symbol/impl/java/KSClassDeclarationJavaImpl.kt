...
import io.github.bkmbigo.gallery.ksp.isConstructor
...
class KSClassDeclarationJavaImpl private constructor(val psi: PsiClass) :
    ...
    override val superTypes: Sequence<KSTypeReference> by lazy {
        ...
        adjusted.asSequence().map { io.github.bkmbigo.gallery.ksp.symbol.impl.java.KSTypeReferenceJavaImpl.getCached(it, this) }.memoized()
    }
