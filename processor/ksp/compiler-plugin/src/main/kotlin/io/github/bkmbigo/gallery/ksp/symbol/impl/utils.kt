 ...
 */
package io.github.bkmbigo.gallery.ksp.symbol.impl
...
import io.github.bkmbigo.gallery.ksp.symbol.impl.binary.KSDeclarationDescriptorImpl
import io.github.bkmbigo.gallery.ksp.symbol.impl.binary.KSFunctionDeclarationDescriptorImpl
import io.github.bkmbigo.gallery.ksp.symbol.impl.binary.KSPropertyDeclarationDescriptorImpl
import io.github.bkmbigo.gallery.ksp.symbol.impl.binary.KSTypeArgumentDescriptorImpl
...
fun PsiElement.toLocation(): Location {
    ...
    val document = ResolverImpl.instance!!.psiDocumentManager.getDocument(file) ?: return io.github.bkmbigo.gallery.ksp.symbol.NonExistLocation
...
internal fun getInstanceForCurrentRound(node: KSNode): KSNode? {
    return when (node.origin) {
        Origin.KOTLIN_LIB, Origin.JAVA_LIB -> null
            ...
            is KSTypeReferenceJavaImpl -> KSTypeReferenceJavaImpl.getCached(node.psi, (node.parent as? KSAnnotated)?.getInstanceForCurrentRound())
