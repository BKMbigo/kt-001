...
import io.github.bkmbigo.gallery.ksp.impl.KotlinSymbolProcessing
import io.github.bkmbigo.gallery.ksp.processing.ExitCode
import io.github.bkmbigo.gallery.ksp.processing.KSPCommonConfig
import io.github.bkmbigo.gallery.ksp.processing.KSPConfig
import io.github.bkmbigo.gallery.ksp.processing.KSPJsConfig
import io.github.bkmbigo.gallery.ksp.processing.KSPJvmConfig
import io.github.bkmbigo.gallery.ksp.processing.KSPNativeConfig
...
abstract class KspAAWorkerAction : WorkAction<KspAAWorkParameter> {
    override fun execute() {
        ...
        val processorProviders = ServiceLoader.load(
            processorClassloader.loadClass("io.github.bkmbigo.gallery.ksp.processing.SymbolProcessorProvider"),
        ...
        val exitCode = try {
            val kspLoaderClass = isolatedClassLoader.loadClass("io.github.bkmbigo.gallery.ksp.impl.KSPLoader")
